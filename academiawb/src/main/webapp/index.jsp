      ...
      <div class="container">
          <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom">
            <a href="" class="d-flex align-items-center col-md-3 mb-2 mb-md-0 text-dark text-decoration-none">
              <img class="bi me-2" src="https://i.imgur.com/h68jOwG.png" width="77px" height="47px" alt="">
            ...
            <div class="col-md-3 text-end">
              <a href="LoginFuncionario.jsp" class="btn btn-outline-primary me-2" role="button" aria-disabled="true">Login funcionário</a>
              <a href="LoginAluno.jsp" class="btn btn-primary" role="button" aria-disabled="true">Login aluno</a>
            </div>
          </header>
        </div>
    </header>
